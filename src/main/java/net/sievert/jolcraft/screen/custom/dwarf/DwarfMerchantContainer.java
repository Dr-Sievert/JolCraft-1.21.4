...
public class DwarfMerchantContainer implements Container {
    ...
    @Nullable
    private DwarfMerchantOffer activeOffer;
    private int selectionHint;
    private int futureXp;

    public DwarfMerchantContainer(DwarfMerchant merchant) {
    ...
    public void updateSellItem() {
        ...
        if (itemstack.isEmpty()) {
            ...
            DwarfMerchantOffers merchantoffers = this.merchant.getOffers();
            if (!merchantoffers.isEmpty()) {
                DwarfMerchantOffer merchantoffer = merchantoffers.getRecipeFor(itemstack, itemstack1, this.selectionHint);
    ...
    @Nullable
    public DwarfMerchantOffer getActiveOffer() {
