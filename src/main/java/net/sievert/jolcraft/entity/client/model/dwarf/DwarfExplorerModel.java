...
public class DwarfExplorerModel extends DwarfModel{
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        head.addOrReplaceChild("hat", CubeListBuilder.create().texOffs(92, 0).addBox(-5.0F, -5.0F, -4.0F, 10.0F, 10.0F, 8.0F, new CubeDeformation(0.25F))
                .texOffs(0, 115).addBox(-5.26F, -8.25F, -4.0F, 0.01F, 5.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -3.0F, 2.0F));
