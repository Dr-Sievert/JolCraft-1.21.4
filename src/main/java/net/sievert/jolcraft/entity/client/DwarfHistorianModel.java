...
public class DwarfHistorianModel extends DwarfModel{
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        head.addOrReplaceChild("glasses", CubeListBuilder.create().texOffs(82, 14).addBox(-3.0F, -3.75F, -4.76F, 2.0F, 1.0F, 0.0F, new CubeDeformation(0.0F))
                .texOffs(84, 14).addBox(1.0F, -3.75F, -4.76F, 2.0F, 1.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));
