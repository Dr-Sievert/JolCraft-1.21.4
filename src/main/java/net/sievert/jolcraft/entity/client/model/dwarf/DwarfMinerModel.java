...
public class DwarfMinerModel extends DwarfModel{
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        body.addOrReplaceChild("backpack", CubeListBuilder.create().texOffs(0, 116).addBox(-5.0F, -7.0F, 3.0F, 10.0F, 9.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 1.0F, 0.0F));
