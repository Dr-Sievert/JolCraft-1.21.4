...
public class ForgeStructure extends Structure {
    ...
    public ForgeStructure(Structure.StructureSettings config,
    ...
    public Optional<Structure.GenerationStub> findGenerationPoint(Structure.GenerationContext context) {
        ...
        if (!ForgeStructure.extraSpawningChecks(context)) {
    ...
    public StructureType<?> type() {
        return JolCraftStructures.FORGE_STRUCTURE.get(); // Helps the game know how to turn this structure back to json to save to chunks
    }
}