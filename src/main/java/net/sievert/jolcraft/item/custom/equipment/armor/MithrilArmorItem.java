...
public class MithrilArmorItem extends ArmorItem {
    ...
    private static final Map<ArmorMaterial, List<MobEffectInstance>> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<ArmorMaterial, List<MobEffectInstance>>())
                    .put(JolCraftArmorMaterials.MITHRIL_ARMOR_MATERIAL,
                            List.of(new MobEffectInstance(MobEffects.GLOWING, 300, 0, false, false),
                                    new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 300, 0, false, false)))
                    .build();
